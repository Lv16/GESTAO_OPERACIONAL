...
function renderAgingEmAndamentoFromSummary(summary){
    ...
    const defaultLabels = ['0-2 dias', '3-5 dias', '6-10 dias', '11+ dias', 'Sem inicio'];
    ...
    const avgDays = Number(aging.avg_days || 0);
    ...
    if(info){
        info.innerHTML = `
            ...
            <span class="funil-chip">Média idade: <b>${formatNumberPt(avgDays, 1)}d</b></span>
            ...
            oldestListEl.innerHTML = topOldest.map((item) => {
                ...
                return `
                    <div class="aging-oldest-row">
                        ...
                        <span class="aging-oldest-days">${Intl.NumberFormat('pt-BR').format(dias)}d</span>
                    </div>
                `;
            }).join('');
        }
