...
class RdoTankPersistenceTest(TestCase):
    def setUp(self):
        # usuário mínimo para associar ao request
        ...
        # criar um RDO simples
        self.rdo = RDO.objects.create(rdo='RDO-TEST')
        # criar dois tanques associados
    ...
    def test_per_tank_update_persists_and_quantizes(self):
        # Simula update para um tanque específico
        payload = {
            ...
            # incluir aliases que frontend pode enviar
            'sup-limp': '21.216',
            'sup-limp-acu': '30',
            'sup-limp-fina': '5.556',
            'sup-limp-fina-acu': '3',
        ...
        # Decimals devem estar quantizados a 2 casas
        ...
        # limpeza fina diária quantizada
        self.assertIsNotNone(self.t1.limpeza_fina_diaria)
        self.assertEqual(self.t1.limpeza_fina_diaria, Decimal('5.56'))
        # no código atual este valor é persistido em `percentual_limpeza_fina_cumulativo`
    ...
    def test_rdo_level_replication_updates_all_tanks(self):
        # Simula um POST no RDO sem tanque_id: deve replicar para todos os tanques
        payload = {
        ...
        # Ambos devem ter recebido as informações replicadas (quantizadas)
        ...
        # o cumulativo fino é persistido como `percentual_limpeza_fina_cumulativo`
